...
export const addTransportWaste = (pname,productcode,procuctstanderd,productunite,wastetype,remarkable,wasteweight, pageNum = 1, pageSize = 10, repositoryid = repoId) => axio('/repositoryb/addDailyWaste',{pname,productcode,procuctstanderd,productunite,wastetype,remarkable,wasteweight, pageNum , pageSize, repositoryid});
 ...
 * B库-货品管理--选择供应商
 */
export const querySnameByTSupplierorder_a = () => axio('/productmanager/querySnameByTSupplierorder');
...
export const getdisableUser = (uid) => axio('/user/disableUser', {uid});

/**
 * 启用用户
 */

export const getstartUser = (uid) => axio('/user/startUser', {uid});
...
export const makeStockIn = (ordercode, visualreposity, storagename, goodscode, storageproducttype, prostandered, prounite, grossweight, tare, perprice, totalmoney, netweight, supplierid, prostandared, ordernumber, createtime, pronumber, isStandard, storagetype = 'A库入库', repositoryposition = repoId) => axio('/storageordera/insertStorageordera',{ordercode, visualreposity, storagename, goodscode, storageproducttype, prostandered, prounite, grossweight, tare, perprice, totalmoney, netweight, supplierid, prostandared, ordernumber, createtime, pronumber, isStandard, storagetype, repositoryposition});
...
export const getinsertInspectAFromAll_b = (repositoryid = repoId, username = unames) => axio('/tinspect/insertInspectBFromAll',{repositoryid, username});
...
export const getchangeStateAndInseptTwo_b = (checkid, repositoryposition = repoId, username = unames) => axio('/tinspect/changeStateAndInseptTwo2',{checkid, repositoryposition, username});
...
export const getsqueryStateAndInseptAndOne_a = (pageNum = 1, pageSize = 10, repositoryposition = repoId) => axio('/inspecta/queryStateAndInseptAndOne',{pageNum, pageSize, repositoryposition});
...
export const getchangeStateAndInseptTwo_a = (checkid, repositoryposition = repoId, username = unames) => axio('/inspecta/changeStateAndInseptTwo2',{checkid, repositoryposition, username});
...
export const transmitEnable = (supplierid) => axio('/supplierorder/startSupplierorder', {supplierid});
...
export const getByRepository_a = (pageNum = 1,pageSize = 10) => axio('/keepdate/getByRepository',{pageNum,pageSize});

/**
 * A库-按条件查询保质期提醒
 */

export const getByCondition_a = (pname, proid, startTime, endTime, pageNum = 1, pageSize = 10) => axio('/keepdate/getByCondition',{pname, proid, startTime, endTime, pageNum, pageSize});
