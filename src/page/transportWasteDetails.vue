<template>
    <div>
        ...
        <el-row style="margin-top: 20px;">
			<el-col :span="8">
				单据编号：&nbsp;{{receiptData.orderid}}
			</el-col>
            <el-col :span="8">
				单据日期：&nbsp;{{receiptData.ordertime}}
			</el-col>
            <el-col :span="8">
				默认仓库：&nbsp;{{receiptData.defaultrepository}}
			</el-col>
		</el-row>
        <el-row>
			<el-col :span="8">
				采购员：&nbsp;{{receiptData.buyhuman}}
			</el-col>
            <el-col :span="8">
				采购类型：&nbsp;{{receiptData.buytype}}
			</el-col>
            <el-col :span="8">
				采购部门：&nbsp;{{receiptData.buydepartment}}
			</el-col>
		</el-row>
        <el-row>
			<el-col :span="8">
				发运方式：&nbsp;{{receiptData.sendtype}}
			</el-col>
		</el-row>
		<el-table
			:data="receiptData"
